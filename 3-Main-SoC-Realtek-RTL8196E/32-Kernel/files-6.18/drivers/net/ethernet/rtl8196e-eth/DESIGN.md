...
| **Active release** | v4.4.0 (kernels `6.18.45` and `7.1.9`, `-rtl8196e-v4.4.0`); driver 2.24 adds true board-aware LAN LED off without changing the v2.23 datapath/recovery baseline |
